...
void psci_prepare_next_non_secure_ctx(entry_point_info_t *next_image_info)
{
	...
	ATF_BP(" START: cm_init_my_context(next_image_info); in psci_prepare_next_non_secure_ctx [psci_setup]\n");

	cm_init_my_context(next_image_info);
	ATF_BP(" FINISH: cm_init_my_context(next_image_info); in psci_prepare_next_non_secure_ctx [psci_setup]\n");
