...
struct dyn_cfg_dtb_info_t *dyn_cfg_dtb_info_getter(unsigned int config_id)
{
	...
	// ATF_BP(" ------------- Print All dtb_infos[i] -------------\n");

	// for(int i=0;i<MAX_DTB_INFO;i++)
	// {
	// 	ATF_BP(" ------------- Print dtb_infos[%d] -------------\n",i);
	// 	ATF_BP(" dtb_infos[%d].config_addr is %lx\n",i,dtb_infos[i].config_addr);
	// 	ATF_BP(" dtb_infos[%d].config_max_size is %x\n",i,dtb_infos[i].config_max_size);
	// 	ATF_BP(" dtb_infos[%d].config_id is %d\n",i,dtb_infos[i].config_id);
	// 	ATF_BP(" dtb_infos[%d].secondary_config_addr is %lx\n",i,dtb_infos[i].secondary_config_addr);
	// 	ATF_BP(" ------------- Print dtb_infos[%d] -------------\n",i);
