			 ...
			 size_t *length_read)
{
	...
	ATF_BP(" [READY] io_read(backend_handle, (uintptr_t)&header, sizeof(header), &bytes_read); [io_encrypted]\n");
	...
	ATF_BP(" [READY] io_read(backend_handle, buffer, length, &bytes_read); [io_encrypted]\n");
