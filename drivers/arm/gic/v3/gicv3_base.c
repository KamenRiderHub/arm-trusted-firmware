...
{
	ATF_BP(" START: gicv3_driver_init(&gic_data); [gicv3_base]\n");
	ATF_BP(" GIC_ENABLE_V4_EXTN is %d [gicv3_base]\n", GIC_ENABLE_V4_EXTN);

	gicv3_driver_init(&gic_data);

	ATF_BP(" FINISH: gicv3_driver_init(&gic_data); [gicv3_base]\n");

	ATF_BP(" START: gicv3_distif_init(); [gicv3_base]\n");

	gicv3_distif_init();

	ATF_BP(" FINISH: gicv3_distif_init(); [gicv3_base]\n");
