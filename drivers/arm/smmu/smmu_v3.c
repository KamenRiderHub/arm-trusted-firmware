...
{
	ATF_BP(" START: smmuv3_poll [1] in smmuv3_security_init [smmu_v3]\n");
	...
	ATF_BP(" FINISH: smmuv3_poll [1] in smmuv3_security_init [smmu_v3]\n");
	...
	ATF_BP(" START: smmuv3_poll [2] in smmuv3_security_init [smmu_v3]\n");
	if (smmuv3_poll(smmu_base + SMMU_GBPA, SMMU_GBPA_UPDATE, 0U) != 0U)
		return -1;

	ATF_BP(" FINISH: smmuv3_poll [2] in smmuv3_security_init [smmu_v3]\n");
