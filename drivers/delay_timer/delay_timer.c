...
void timer_init(const timer_ops_t *ops_ptr)
{
	...
	ATF_BP(" Here is timer_init in [delay_timer]\n");
	ATF_BP(" START: assert in timer_init [delay_timer]\n");
	...
	timer_ops = ops_ptr;
	ATF_BP(" START: timer_ops->clk_mult = %u, ops_ptr->clk_div = %u in timer_init [delay_timer]\n", ops_ptr->clk_mult, ops_ptr->clk_div);
...
{
	ATF_BP(" START: assert(timer_ops != NULL); in timeout_init_us [delay_timer]\n");

	assert(timer_ops != NULL);

	ATF_BP(" FINISH: assert(timer_ops != NULL); in timeout_init_us [delay_timer]\n");
	...
	ATF_BP(" FINISH: assert(timer_ops->timeout_init_us != NULL); in timeout_init_us [delay_timer]\n");
