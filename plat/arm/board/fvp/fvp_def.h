...
//【注】DEVICE0原本用于包含EL2 Generic Watchdog Control、SMMUv3、GICC（GIC Physical CPU interface）、GICH（GIC Virtual Interface Control）、GICV（GIC Virtual CPU Interface）
//【改】现在DEVICE0用于做smmu的map，地址改为0x00_0D00_0000
/* Aggregate of all devices in the first GB */
// #define DEVICE0_BASE			UL(0x20000000)
// #define DEVICE0_SIZE			UL(0x0c200000)
#define DEVICE0_BASE			UL(0x0D000000)
#define DEVICE0_SIZE			UL(0x01000000) // 16MB

/*
 *  In case of FVP models with CCN, the CCN register space overlaps into
 *  the NSRAM area.
 */
// 【改】【2】直接将DEVICE1_BASE赋值为“GIC中断控制器（HN-I）”的基地址，DEVICE1_SIZE赋值为“GIC中断控制器（HN-I）”的大小（引入了CX_GIC_BASE和CX_GIC_SIZE）
...
#define DEVICE1_BASE			CX_GIC_BASE
#define DEVICE1_SIZE			CX_GIC_SIZE
...
//【改】BASE_GICD_BASE地址改为0x0e00 0000
// #define BASE_GICD_BASE			UL(0x2f000000)
#define BASE_GICD_BASE			UL(0x0e000000)
#define BASE_GICD_SIZE			UL(0x10000)
//【改】文档里说的RD控制和物理LPI寄存器，好像是对应官方“corelink gic700”的“Redistributor registers for control and physical LPIs”
//【改】文档里说的RD SGI和PPI寄存器，好像是对应官方“corelink gic700”的“Redistributor registers for SGIs and PPIs”
//【改】所以这个GICR地址就写成0x0e08 0000(偏移量写在里面了)

#define BASE_GICR_BASE			UL(0x0e080000)
