...
# FVP_TRUSTED_SRAM_SIZE		:= 256*4*30
endif
...
# 【改】没有CCI或CCN，CMN被scp那边管理。这里留下一个CMN定义预防万一
...
# endif
FVP_INTERCONNECT_DRIVER := FVP_CMN
...
# 【改】没有CCI或CCN，CMN被scp那边管理。这里直接去掉
...
#【改】让它加上rdn2的东西以便于cpu_ops，但是我怀疑cpu_ops那里不去赋值为rdn2，换成赋值为a53之类的也行
#【注】为了FVP_CPU_LIBS	+=	lib/cpus/aarch64/neoverse_n2.S		
...
# 【改】去掉部分“lib/cpus/aarch64/xxxx”，不然太多了编译器编译时超出上限
#原本有：
