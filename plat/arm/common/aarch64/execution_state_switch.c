		...
		void *handle)
{
	 ...
	 * calling EL.
	 */
	ATF_BP(" START: cm_init_my_context(&ep); in arm_execution_state_switch [execution_state_switch]\n");
	
	cm_init_my_context(&ep);
	ATF_BP(" FINISH: cm_init_my_context(&ep); in arm_execution_state_switch [execution_state_switch]\n");
