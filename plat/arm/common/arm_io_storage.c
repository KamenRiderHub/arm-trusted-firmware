...
// //【改】增加打印uuid函数
// static void atf_uuid_to_str(char *s, size_t len, const uuid_t *u)
// {
// 	//assert(len >= (_UUID_STR_LEN + 1));

// 	snprintf(s, len,
// 	    "ATF_BP: UUID = %02X%02X%02X%02X-%02X%02X-%02X%02X-%04X-%04X%04X%04X\r\n",
...
// 	    (u->node[4] << 8) | u->node[5]);
// }
// static void atf_print_uuid(const uuid_t *u)
// {
//     char str[128];
//     atf_uuid_to_str(str, sizeof(str), u);
//     printf("%s", str);
// }

// static void atf_print_uuid_ALL(void)
// {
// 	// ATF_BP(" -------------*Print all uuid*-------------\r\n");
// 	struct plat_io_policy *policy_tmp;
// 	// printf("* ATF_BP: image_id = 0 *\r\n");
// 	// for(int i=0;i<1;i++)
// 	// {
// 	// 	policy_tmp = FCONF_GET_PROPERTY(arm, io_policies, i);
// 	// 	io_uuid_spec_t *u =(io_uuid_spec_t *)(policy_tmp->image_spec);
// 	// 	atf_print_uuid(&(u->uuid));
// 	// }
// 	// printf("* ATF_BP: image_id = 32 *\r\n");
// 	for(int i=0;i<MAX_NUMBER_IDS;i++)
// 	{
// 		policy_tmp = FCONF_GET_PROPERTY(arm, io_policies, i);
// 		io_uuid_spec_t *u =(io_uuid_spec_t *)(policy_tmp->image_spec);
// 		atf_print_uuid(&(u->uuid));
