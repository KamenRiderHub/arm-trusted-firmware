...
#endif /* TRANSFER_LIST */
	ATF_BP(" bl33_image_ep_info.pc = %lx\n",bl33_image_ep_info.pc);
	ATF_BP(" bl33_image_ep_info.spsr = %x\n",bl33_image_ep_info.spsr);
	ATF_BP(" bl33_image_ep_info.args.arg0 = %lx\n",bl33_image_ep_info.args.arg0);
...
#endif /* RESET_TO_BL31 */
//【改】跟之前一样注释掉mmio_write_32(ARM_SYS_CNTCTL_BASE……和arm_configure_sys_timer
...
{
	ATF_BP(" Here is arm_bl31_plat_runtime_setup [arm_bl31_setup]\n");
