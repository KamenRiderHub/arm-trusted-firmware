...
//【改】增加一个自己测试的LOG_LEVEL，LOG_LEVEL_VERBOSE改成60
#define LOG_LEVEL_ATF_BP		U(50)
#define LOG_LEVEL_VERBOSE		U(60)
...
//【改】增加一个自己测试的LOG_MARKER，LOG_MARKER_VERBOSE改成0x3c
#define LOG_MARKER_ATF_BP		"\x32"	/* 50 */
#define LOG_MARKER_VERBOSE		"\x3c"	/* 60 */
/*
...
//【改】增加一个自己测试的LOG
#if LOG_LEVEL >= LOG_LEVEL_ATF_BP
# define ATF_BP(...)	tf_log(LOG_MARKER_ATF_BP __VA_ARGS__)
#else
# define ATF_BP(...)	no_tf_log(LOG_MARKER_ATF_BP __VA_ARGS__)
#endif
