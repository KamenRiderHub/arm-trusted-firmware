...
//【改】将cx芯片的 QSPI Flash 的后半部分划分代替flash0（flash0用于存放fip镜像等内容）
//【注】FLASH1在启用了 SPM_MM宏之后才会用上，可删掉可不管
/* NOR Flash */
//#define V2M_FLASH0_BASE			(V2M_OFFSET + UL(0x08000000))
#define V2M_FLASH0_BASE			UL(0x00800000)
// #define V2M_FLASH0_SIZE			UL(0x04000000) // 64MB
#define V2M_FLASH0_SIZE			UL(0x07800000)

#define V2M_FLASH1_BASE			(V2M_OFFSET + UL(0x0c000000))
#define V2M_FLASH1_SIZE			UL(0x04000000)
#define V2M_FLASH_BLOCK_SIZE		UL(0x00040000) /* 256 KB */

//【改】用V2M_IOFPGA_BASE来表示cx芯片上的“除RN-F、SN-F外的设备寄存器地址，除表中单独列出的寄存器以外，其它所有寄存器 （HN-D之NIC）”
//【注】这样就照常使用V2M_MAP_IOFPGA，plat_arm_mmap[]内的V2M_MAP_IOFPGA不用变动
// #define V2M_IOFPGA_BASE			(V2M_OFFSET + UL(0x1c000000))
// #define V2M_IOFPGA_SIZE			UL(0x03000000)
#define V2M_IOFPGA_BASE			UL(0x0c000000)
#define V2M_IOFPGA_SIZE			UL(0x01000000) //16MB

//【改】修改UART0、UART1地址，注释掉UART2、UART3
...
#define V2M_IOFPGA_UART0_BASE		UL(0x0c000000)
#define V2M_IOFPGA_UART1_BASE		UL(0x0c001000)
...
#define V2M_MAP_FLASH0_RO		MAP_REGION_FLAT(V2M_FLASH0_BASE,\
						V2M_FLASH0_SIZE,	\
						(MT_NON_CACHEABLE | MT_RO | MT_EXECUTE_NEVER) | MT_SECURE)



//【改】临时测试一块覆盖整个地址空间的东西
#define CX_MAP_FLASH_BIG1		MAP_REGION_FLAT(0x0,\
						V2M_FLASH0_BASE,	\
						MT_DEVICE | MT_RW | MT_SECURE)

#define CX_MAP_FLASH_BIG2		MAP_REGION_FLAT(0x84001000,\
						0x3FFF000,	\
						MT_DEVICE | MT_RW | MT_SECURE)
#define CX_MAP_FLASH_BIG3		MAP_REGION_FLAT(0x08000000,\
						0x78000000,	\
						MT_DEVICE | MT_RW | MT_SECURE)
#define CX_MAP_FLASH_BIG4		MAP_REGION_FLAT(0x80000000,\
						0x4001000,	\
						MT_DEVICE | MT_RW | MT_SECURE)
#define CX_MAP_FLASH_BIGBIG		MAP_REGION_FLAT(0x0,\
						0x100000000,	\
						MT_DEVICE | MT_RW | MT_EXECUTE)						
